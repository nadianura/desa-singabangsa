	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<img src="../images/logo.png" width="50" height="50" align='left'>&nbsp;
				<a class="navbar-brand" href="home.php?page=beranda" align='left'><span>SIDESI<br>Administrator</span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			<div class="profile-userpic">
				<img src="../images/admin.ico" class="img-responsive" alt=""/>
			</div>
      ...
      ?>
				...
				<div class="profile-usertitle-name"> <?php echo  $data['nm_pegawai'];    ?> </div>
	  <?php
	  }
	  ?>
		...
		<ul class="nav menu" >
			...
			<li><a href="home.php?page=saran"><i class="glyphicon glyphicon-link"></i> Kritik & Saran</a></li>			
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					<li><a class="" href="home.php?page=lap_jurnalis">
						<span class="fa fa-arrow-right">&nbsp;</span>Lap.Data Jurnalis
					</a></li>
					<li><a class="" href="home.php?page=lap_penduduk">
						<span class="fa fa-arrow-right">&nbsp;</span>Lap.Penduduk
					</a></li>
					<li><a class="" href="home.php?page=lap_berita">
						<span class="fa fa-arrow-right">&nbsp;</span>Lap.Berita
					</a></li>
				</ul>
			</li>
